...
if("TRUE" STREQUAL "TRUE")
  set(enshu_20151014_SOURCE_PREFIX /home/mech-user/2015-soft3/20151014/src/enshu_20151014)
  set(enshu_20151014_DEVEL_PREFIX /home/mech-user/2015-soft3/20151014/devel)
  ...
  set(enshu_20151014_INSTALL_PREFIX /home/mech-user/2015-soft3/20151014/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'enshu_20151014' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'k-okada <k-okada@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'enshu_20151014' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mech-user/2015-soft3/20151014/src/enshu_20151014/${idir}'.  Ask the maintainer 'k-okada <k-okada@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mech-user/2015-soft3/20151014/devel/lib;/opt/ros/indigo/lib)
