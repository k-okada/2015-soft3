  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'workspace' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'mech-user <mech-user@todo.todo>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'workspace' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mech-user/git/2015-soft3/20151014/src/workspace/${idir}'.  Ask the maintainer 'mech-user <mech-user@todo.todo>' to fix it.")
    endif()
