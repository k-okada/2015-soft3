...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'enshu_20151021' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/shuta/git/2015-soft3/2015-soft3/20151021/install/${idir}'.  Ask the maintainer 'k-okada <k-okada@todo.todo>' to fix it.")
    endif()
