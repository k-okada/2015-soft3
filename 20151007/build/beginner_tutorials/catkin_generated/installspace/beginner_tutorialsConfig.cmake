...
if(NOT "include" STREQUAL "")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir}" STREQUAL "include")
      ...
      message(FATAL_ERROR "Project 'beginner_tutorials' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mech-user/soft3/2015-soft3/20151007/install/${idir}'.  Ask the maintainer 'mech-user <mech-user@todo.todo>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/mech-user/soft3/2015-soft3/20151007/install/lib;/home/mech-user/soft3/2015-soft3/20151007/devel/lib;/opt/ros/indigo/lib)
